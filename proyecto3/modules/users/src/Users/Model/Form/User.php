...
$register = array(
    ...
    'city' => array(
        ...
        'validation'=>array(            
                    array(
                            'type'=>'inarray',
                            'error'=>'No esta en la lista de opciones Poblaciones',
                            'options'=>array()
                        ),                  
        ),
    ),
    'languages' => array(
        ...
        'label'=>'Idiomas:',
        'name'=>'languages',
        'options'=>array('eng'=>'Ingles', 'esp'=>'Castellano', 'cat'=>'Catalá'),
        ...
        'validation'=>array(            
                    array(
                            'type'=>'inarray',
                            'error'=>'No esta en la lista de opciones Idiomas',
                            'options'=>array()
                        ),                  
        ),
    ),
    'gender' => array(
        ...
        'validation'=>array(            
                    array(
                            'type'=>'inarray',
                            'error'=>'No esta en la lista de opciones Sexo',
                            'options'=>array()
                        ),                  
        ),
    ),
    'transport' => array(
        ...
        'validation'=>array(            
                    array(
                            'type'=>'inarray',
                            'error'=>'No esta en la lista de opciones Transportes',
                            'options'=>array()
                        ),                  
        ),
    ),
